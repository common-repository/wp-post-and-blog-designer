...
$wpbd_post_large_image = wpbd_get_post_featured_image( $post->ID, 'large' ); ?>
	<div class="wpbd-medium-6 wpbd-cell wpbd-left-block">
...
?>
	<div class="wpbd-medium-6 wpbd-cell <?php if($grid_count <= 3) { echo 'flotRight'; } ?> <?php if($grid_count == 1) { echo 'clearboth'; } ?>" >
