...
$wpbd_post_large_image = wpbd_get_post_featured_image( $post->ID, 'large' ); ?>
	<div class="wpbd-medium-6 wpbd-cell wpbd-left-block">
		<?php if(!empty($wpbd_post_large_image)) { ?>
		 ...
		 <div class="wpbd-post-inner-content-1">
		 <?php }
...
?>
	<div class="wpbd-medium-6 wpbd-cell <?php if($grid_count <= 3) { echo 'flotRight'; } ?> <?php if($grid_count == 1) { echo 'clearboth'; } ?>" >
		<div class="wpbd-post-right-block wpbd-medium-12 wpbd-cell">
				<div class="<?php if(!empty($wpbd_post_medium_image)) { echo 'wpbd-medium-12 wpbd-cell'; } else { echo 'wpbd-medium-12 wpbd-cell'; } ?> ">
					<div class="wpbd-post-inner-content">
